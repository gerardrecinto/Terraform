...
Cross-account PrivateLink for the DeviceService SSH Gateway (NGINX TCP/SSH ingress on port 22):
...
module "nginx" {
  ...
  tcp_services = {
    "22"   = "device_service/ssh-gateway:22"
    "8883" = "iot-platform/mqtt-broker:8883"
  }
}
```
